...
exports.createTermsCondition = async (req, res) => {
    try {
        ...
        return res.status(200).json({ message: "Terms and Condition created successfully...", data: savedata })
...
exports.updateTermsCondition = async (req, res) => {
    try {
        ...
        const updated = await termsConditionServices.findByIdAndUpdate(id, updateData, { new: true });
...
exports.deleteTermsCondition = async (req, res) => {
    try {
        ...
        const deletedTermsCondition = await termsConditionServices.findByIdAndDelete(id);
