...
exports.updateprivacyPolicy = async (req, res) => {
    try {
        ...
        const updated = await privacyPolicyServices.findByIdAndUpdate(id, updateData, { new: true });
...
exports.deleteprivacyPolicy = async (req, res) => {
    try {
        ...
        const deletedprivacyPolicy = await privacyPolicyServices.findByIdAndDelete(id);
